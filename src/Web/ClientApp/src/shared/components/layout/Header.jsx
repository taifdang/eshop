export function Header() {
  return (
    <div
      ...
      style={{ padding: "16px 0 10px 0", height:"90px", backgroundColor:"rgb(255,255,255)" }}
    >
            ...
            <div className="star-popover relative" id="cart_target_id">
              <div role="button" className="star-popover__target">
                <div className="cart-btn-group ">
                  ...
                  {/* <div className="absolute bottom-50 start-50 badge bg-dark rounded-pill">
                      <span>02</span>
                    </div> */}
                </div>
              </div>
...
<div className="flex flex-row justify-center items-center 100h">
  <div className="star-popover" id="cart_target_id">
    <div role="button" className="star-popover__target">
      <div className="cart-btn-group ">
        <a
          href="/cart"
        ...
        <div
          className="absolute top-2 right-8 bg-black text-white rounded-full"
          style={{ padding: "0 10px" }}
        >
          <span style={{ fontSize: "14px", lineHeight: "16.8px" }}>1</span>
        </div>
        {/* <div className="absolute bottom-50 start-50 badge bg-dark rounded-pill">
                      <span>02</span>
                    </div> */}
