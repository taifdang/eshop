        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Provider = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "None"),
                    Payment_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Method = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "None"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketItem", x => new { x.BasketId, x.ProductVariantId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowImage = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OptionValue_ProductOption_ProductOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OptionValueId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImage_OptionValue_OptionValueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariantOptionValue", x => new { x.ProductVariantId, x.OptionValueId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VariantOptionValue_ProductVariant_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OptionValue_ProductOptionId",
                table: "OptionValue",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImage_OptionValueId",
                table: "ProductImage",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ProductId",
                unique: true,
                filter: "[IsMain] = 1 AND [OptionValueId] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ProductImage_ProductId_OptionValueId",
                table: "ProductImage",
                columns: new[] { "ProductId", "OptionValueId" },
                unique: true,
                filter: "[OptionValueId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantOptionValue_ProductVariantId",
                table: "VariantOptionValue",
                column: "ProductVariantId");
        }
